...
@endif
    ...
    <div class="flex flex-col text-center items-center mt-10">
        <a href="{{ route('admin.crewMembers.create') }}"
                ...
                <div class="flex flex-col justify-between w-1/4 p-5 bg-[#b9bfd3] rounded-xl shadow-md text-black">
                    ...
                    <div class="flex justify-between">
                        <a href="{{ route('admin.crewMembers.edit', $crewMember) }}"
                         ...
                         <form action="{{ route('admin.crewMembers.destroy', $crewMember->id) }}" method="POST" onsubmit="return confirm('Supprimer cette crewMember ?');">
                            @csrf
                            @method('DELETE')
